...
<body bgcolor="#000B46">
    ...
    <div class="button-3"><i class="i-2 fa-solid fa-user"></i> <span id="user-name">Գրանցված չէ</span></div>
        ...
        <div class="other-td">
            <div class="menu-titles">
                ...
                <div class="menu-buttons">
                    <a href="play.php" class="button-2"><i class="i-1 fa-solid fa-play"></i> Սկսել</a>
                    <br>
